...
vi.mock('../../features/orders/api', () => ({ ordersApi: {
  listMyOrders: vi.fn().mockResolvedValue({ items: [{ id: 'o1', orderNumber: 'DM-1', status: 'Pending', total: 100, itemCount: 1, currency: 'EGP', createdAt: '2026-01-01T00:00:00Z' }], page: 1, pageSize: 20, totalCount: 1, totalPages: 1 }),
} }));
