...
internal sealed class OrderConfiguration : IEntityTypeConfiguration<Order>
{
    public void Configure(EntityTypeBuilder<Order> builder)
    {
        ...
        builder.Property(o => o.PendingPaymentReviewAt);

        // ---- Optimistic concurrency (auto-generated by SQL Server). ----------
        builder.Property(o => o.RowVersion).IsRowVersion().IsConcurrencyToken();

        // ---- Payment-instruction snapshots (nullable — pre-migration fallback). -
        builder.Property(o => o.PaymentAccountNumber).HasMaxLength(64);
        builder.Property(o => o.PaymentAccountHolder).HasMaxLength(128);
        builder.Property(o => o.PaymentInstructionsEn).HasMaxLength(1000);
        builder.Property(o => o.PaymentInstructionsAr).HasMaxLength(1000);
