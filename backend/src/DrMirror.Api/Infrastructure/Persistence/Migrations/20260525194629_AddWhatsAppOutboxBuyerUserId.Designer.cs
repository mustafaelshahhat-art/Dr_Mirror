...
namespace DrMirror.Api.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260525194629_AddWhatsAppOutboxBuyerUserId")]
    partial class AddWhatsAppOutboxBuyerUserId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DrMirror.Api.Domain.Entities.GovernorateShippingFee", b =>
                {
                    ...
                    b.HasIndex("LastUpdatedByAdminId");

                    b.HasIndex("Slug")
                        .IsUnique();

                    b.ToTable("GovernorateShippingFees", null, t =>
                        {
                            t.HasCheckConstraint("CK_GovernorateShippingFees_Fee_NonNegative", "[Fee] >= 0");
                        });
                });
            ...
            modelBuilder.Entity("DrMirror.Api.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<string>("ShippingGovernorateNameAr")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("ShippingGovernorateNameEn")
                        .HasMaxLength(100)
                        .IsUnicode(false)
                        .HasColumnType("varchar(100)");
            ...
            modelBuilder.Entity("DrMirror.Api.Domain.Entities.ReturnRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("DrMirror.Api.Domain.Entities.ReturnRequestItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("ReturnRequestItems", null, t =>
                        {
                            t.HasCheckConstraint("CK_ReturnRequestItems_Quantity_Positive", "[Quantity] > 0");
                        });
                });
            ...
            modelBuilder.Entity("DrMirror.Api.Domain.Entities.GovernorateShippingFee", b =>
                {
                    b.HasOne("DrMirror.Api.Domain.Entities.User", "LastUpdatedByAdmin")
                        .WithMany()
                        .HasForeignKey("LastUpdatedByAdminId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("LastUpdatedByAdmin");
                });
            ...
            modelBuilder.Entity("DrMirror.Api.Domain.Entities.ReturnRequest", b =>
                {
                    ...
                    b.HasOne("DrMirror.Api.Domain.Entities.User", "ReviewedByAdmin")
                        .WithMany()
            ...
            modelBuilder.Entity("DrMirror.Api.Domain.Entities.ReturnRequestItem", b =>
                {
                    b.HasOne("DrMirror.Api.Domain.Entities.OrderItem", "OrderItem")
                        .WithMany()
                    ...
                    b.HasOne("DrMirror.Api.Domain.Entities.ReturnRequest", "ReturnRequest")
                        .WithMany("Items")
