...
public class ConcurrentCheckoutTests : IClassFixture<ConcurrentCheckoutTests.Factory>
{
    ...
    public async Task Two_simultaneous_checkouts_for_same_variant_results_in_one_success_one_conflict()
    {
        ...
        var buyer1 = new User { Id = user1Id, FullName = "Buyer 1", Email = "buyer1@example.com", UserName = "buyer1@example.com", EmailConfirmed = true, PhoneNumber = "+201000000000", PhoneNumberConfirmed = true };
        var buyer2 = new User { Id = user2Id, FullName = "Buyer 2", Email = "buyer2@example.com", UserName = "buyer2@example.com", EmailConfirmed = true, PhoneNumber = "+201000000000", PhoneNumberConfirmed = true };
